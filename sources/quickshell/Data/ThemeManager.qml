...
Singleton {
    ...
    // Current theme selection - defaults to gruvbox_dark if not set
    readonly property string currentThemeId: Settings.currentTheme || "gruvbox_dark"
    readonly property var currentTheme: themes[currentThemeId] || themes["gruvbox_dark"]
    ...
    Component.onCompleted: {
        if (!Settings.currentTheme) {
            ...
            Settings.currentTheme = "gruvbox_dark"
    ...
    function toggleTheme() {
        ...
        if (!themes[newThemeId]) {
            newThemeId = currentTheme.type === "dark" ? "gruvbox_light" : "gruvbox_dark"
        }
